// Rate Limiting Middleware for API requests to prevent abuse of the API 
// by a single user or IP address by limiting the number of requests 
// they can make within a certain time frame.
